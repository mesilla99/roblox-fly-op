-- =========================
-- CAMERA FLY FINAL (360 + PITCH + SMOOTH)
-- Script by DOFY
-- =========================
...
local function startFly()
    ...
    conn = RunService.RenderStepped:Connect(function()
        ...
        local dir = f * move:Dot(f) + r * move:Dot(r)
        if dir.Magnitude > 0 then dir = dir.Unit end

        currentVelocity = currentVelocity:Lerp(dir * SPEED, ACCEL)
        bv.Velocity = currentVelocity

        bg.CFrame = CFrame.lookAt(hrp.Position, hrp.Position + f, Vector3.new(0,1,0))
    end)
end
...
frame.Size = UDim2.fromScale(0.55,0.32)
...
Instance.new("UIPadding", frame).PaddingTop = UDim.new(0,12)

local header = Instance.new("TextLabel", frame)
header.Size = UDim2.new(1,-20,0,32)
header.BackgroundTransparency = 1
header.Text = "FLY V1.0 — by DOFY"
...
toggle.TextSize = 14
toggle.BackgroundColor3 = Color3.fromRGB(30,55,120)
...
hideBtn.TextSize = 13
hideBtn.BackgroundColor3 = Color3.fromRGB(18,30,65)
hideBtn.TextColor3 = Color3.new(1,1,1)
Instance.new("UICorner", hideBtn).CornerRadius = UDim.new(0,12)

-- =========================
-- FLOATING ICON (DRAG + PERFECT SIZE)
-- =========================
local iconBtn = Instance.new("ImageButton", gui)
iconBtn.Size = UDim2.fromScale(0.20,0.20)
iconBtn.Position = UDim2.fromScale(0.9,0.5)
iconBtn.AnchorPoint = Vector2.new(0.5,0.5)
iconBtn.BackgroundTransparency = 1
iconBtn.Image = "rbxassetid://101689883102462"
iconBtn.Visible = false
iconBtn.ZIndex = 50

-- KEEP IMAGE SQUARE
Instance.new("UIAspectRatioConstraint", iconBtn).AspectRatio = 1
...
speedRow.Size = UDim2.new(1,-20,0,40)
speedRow.BackgroundTransparency = 1

local rowLayout = Instance.new("UIListLayout", speedRow)
...
minus.TextSize = 20
minus.BackgroundColor3 = Color3.fromRGB(20,40,90)
...
speedLabel.TextColor3 = Color3.fromRGB(200,215,255)
...
plus.TextSize = 20
plus.BackgroundColor3 = Color3.fromRGB(20,40,90)
